...
INSERT INTO tasks(
    task_name, process_id, status_id, priority_id, estimated_time, deadline
) VALUES (
    "システム概要記述", 1, 1, 5,"3:30:00", "2023-02-21"
), (
    "開発目的記述", 1, 2, 2, "4:00:00", "2023-02-28"
), (
    "拡張性記述", 2, 3, 4, "2:00:00", "2023-03-10"
), (
    "耐障害性記述", 2, 2, 3, "1:30:00", "2023-03-17"
), (
    "ほげほげ記述", 2, 1, 1, "3:00:00", "2023-03-27"
), (
    "タスクA", 3, 3, 4, "5:00:00", "2023-03-10"
), (
    "タスクB", 3, 2, 3, "4:30:00", "2023-03-17"
), (
    "タスクC", 3, 1, 1, "3:00:00", "2023-03-27"
),(
    "タスクA", 4, 3, 4, "2:00:00", "2023-03-10"
), (
    "タスクB", 4, 2, 3, "4:30:00", "2023-03-17"
), (
    "タスクC", 4, 1, 1, "3:00:00", "2023-03-27"
),(
    "タスクA", 5, 3, 4, "5:00:00", "2023-03-10"
), (
    "タスクB", 5, 2, 3, "4:30:00", "2023-03-17"
), (
    "タスクC", 5, 1, 1, "3:00:00", "2023-03-27"
)
;
